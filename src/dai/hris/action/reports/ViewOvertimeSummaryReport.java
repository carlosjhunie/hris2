...
@WebServlet("/ViewOvertimeSummaryReport")
public class ViewOvertimeSummaryReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Logger logger = Logger.getLogger(ViewOvertimeSummaryReport.class);
	
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewOvertimeSummaryReport() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		reportStream = getClass().getClassLoader().getResourceAsStream( "dai/hris/reports/OvertimeSummary.jasper");
